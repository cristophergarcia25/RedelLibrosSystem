...
export const Modals = ({ opModal, handleClose, title = '', children, handleNewBook, size ='xl', showFooter = true }) => {
  ...
  return (
    <>
      <Modal size={size} show={openModal} onClose={() => { setOpenModal(false); handleClose(false) }} customClass="custom-modal-bg">
