        ...
        <div className="h-full px-3 py-4 overflow-y-auto bg-celeste dark:bg-celeste">
            ...
            <ul className="space-y-2 font-medium">
                ...
                <li onClick={()=>router.push('/libros/1234342')}>
                    <button type="button" class="flex items-center w-full p-2 text-base  text-white rounded-lgtransition duration-75 rounded-lg group  hover:bg-azul dark:hover:bg-azul group dark:text-white " aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
